  ...
  { unfold Asymmetric; intros.
    ...
    { split.
      - unfold Included; intros; apply AxiomII in H7; destruct H7, H8.
        + apply Theorem19 in H5; apply AxiomII in H8.
          destruct H8; rewrite H9; auto.
        + apply Theorem19 in H6; apply AxiomII in H8.
          destruct H8; rewrite H9; auto.
...
Proof.
  ...
  apply Property_NotEmpty in H; destruct H; double H; apply H0 in H.
  red in H; destruct H, H3; split; unfold Section; intros.
  - split; try split; auto; intros.
    + unfold Included; intros; apply AxiomII in H5.
      destruct H5; apply H6 in H2; auto.
    + destruct H5, H6; apply AxiomII; split; intros; Ens.
      apply AxiomII in H6; destruct H6; double H8; apply H0 in H8.
...
Proof.
  ...
  - apply AxiomII; repeat split; Ens; assert (z ∈ x); auto.
...
Proof.
  ...
  - generalize (classic (y = z)); intro; destruct H2.
    ...
    + apply Lemma_y with (A:=(Section x r z)) in H1; auto.
      apply Lemma_y with (A:=(Section y r z)) in H2; auto.
...
Proof.
  ...
  - apply AxiomII in H; destruct H, H0; apply AxiomII.
    split; auto; exists x; apply AxiomII_P in H0; tauto.
Qed.
...
Proof.
  ...
  apply Property_Value in H1; auto; apply AxiomII_P in H1.
...
Proof.
  ...
  { unfold Function1_1; split; auto; unfold Function; split; intros.
    ...
    - destruct H3; rename y into u; rename z into v.
      apply AxiomII_P in H3; destruct H3; apply AxiomII_P in H4.
  ...
  - unfold Function1_1 in H3; destruct H3 as [_ H3]; unfold Order_Pr; intros.
    ...
    + assert (Rrelation f  [(f⁻¹) [v]] s f [(f⁻¹) [u]] ); auto.
      ...
      generalize (Lemma_y _ _ H5 (Lemma_y _ _ H4 H9)); intro.
...
Proof.
  intros.
  apply AxiomI; split; intros; rewrite Theorem6'; apply AxiomII in H;
...
Proof.
  ...
  intro; destruct H6.
  - generalize (Lemma_y _ _ H0 H3); intro.
  ...
  - assert (\{ λ a, a ∈ (dom( f) ∩ dom( g)) /\ f [a] ≠ g [a] \} ⊂ dom(f)).
    ...
    generalize (Lemma_y _ _ H7 H6); intro.
    ...
    generalize (Lemma_y _ _ H1 H4); intro.
    ...
    + apply H23 in H17; double H17.
      ...
      generalize (Lemma_y _ _ H24 H20); intro.
    ...
    + apply H23 in H20; double H20.
      ...
      generalize (Lemma_y _ _ H17 H24); intro.
...
Proof.
  ...
  assert (a ∈ x); auto; generalize (Lemma_y _ _ H2 H6); intro.
...
Proof.
  ...
  { unfold Section; split.
    ...
    - split; try tauto; intros; destruct H2, H3.
      ...
      apply AxiomII; split; Ens; exists (x1⁻¹[u]).
      apply AxiomII_P; destruct H7 as [H7 [H8 [H9 H10]]]; double H8.
  ...
  { unfold Order_PXY; split; try tauto; split; try tauto.
    ...
    generalize (Lemma_y _ _ H11 H16); intro.
  ...
  - unfold Order_PXY; split; try tauto.
    ...
    destruct H14, H15; apply AxiomII in H14; destruct H14, H17.
...
Proof.
  intros; destruct H.
  generalize (Lemma_y _ _ H H2); intro.
...
Proof.
  ...
  generalize (Lemma_y _ _ H5 H7); intro.
  ...
  - apply Theorem27; split; auto; unfold Included; intros.
    ...
    apply AxiomII_P in H16; destruct H16.
    apply AxiomII_P; split; auto; rewrite H17 in *.
    assert ([a,f[a]] ∈ f).
