...
Proof.
  ...
  - apply Theorem4' in H0; destruct H0.
    ...
    apply Lemma_z with (A:= z∈x \/ z∈y ); auto.
...
Proof.
  ...
  apply AxiomII in H; destruct H; auto.
Qed.
...
Proof.
  ...
  - intros; apply AxiomII in H; destruct H.
    apply Theorem19 in H; apply AxiomII in H; destruct H; contradiction.
Qed.
...
Proof.
  ...
  - unfold Included; intros; apply AxiomII in H0; apply H0; auto.
Qed.
